...
public class ODO {
    ...
    public ODO(@NotBlank String name, @NotBlank Integer quantity, @NotBlank String device, @NotBlank String dscrpt, @NotBlank Boolean inst) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ODO)) return false;
        ODO odo = (ODO) o;
        return Objects.equals(name, odo.name) &&
                Objects.equals(device, odo.device);
    }
    @Override
    public int hashCode() {
